...
void can_transmit(void)
{
	...
	TXB0D0 = can_payload[0];			/* DataByte 0 */
	TXB0D1 = can_payload[1];			/* DataByte 1 */
	TXB0D2 = can_payload[2];			/* DataByte 2 */
	TXB0D3 = can_payload[3];			/* DataByte 3 */
	TXB0D4 = can_payload[4];			/* DataByte 4 */
	TXB0D5 = can_payload[5];			/* DataByte 5 */
	TXB0D6 = can_payload[6];			/* DataByte 6 */
	TXB0D7 = can_payload[7];			/* DataByte 7 */
